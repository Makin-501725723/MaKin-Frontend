...
export default function Order() {
  ...
  const goLinePay = () => {
    if (window.confirm('確認要導向至LINE Pay進行付款?')) {
      ...
      window.location.href = `https://makin-backend.vercel.app/api/line-pay/reserve?orderId=${order.orderId}`
    }
  }
  ...
  useEffect(() => {
    if (router.isReady) {
      ...
      // https://makin-sound.vercel.app/order?transactionId=2022112800733496610&orderId=da3b7389-1525-40e0-a139-52ff02a350a8
